...
public abstract class MyCommonAdapter<T> extends BaseAdapter {
     ...
     */
    public MyCommonAdapter(Context context, int itemLayoutResId, List<T> dataSource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // 获取ViewHolder
        CommonViewHolder commonViewHolder = CommonViewHolder.getViewHolder(mContext, convertView, parent, mItemLayoutId);
        // 填充数据
        fillItemData(commonViewHolder, position, getItem(position));
